...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<head>
		...
		<title>Productos Filtrados por Tope</title>
	...
	?>
		...
		<h3>PRODUCTOS FILTRADOS POR TOPE</h3>
				...
				<tbody>
                	<?php
                    	...
                    	foreach($data as $key => $value){
							...
							echo '<td>' . "<input type= button value= submit onclick= show() </input>" . '</td>';
					    	echo "</tr>";
                		}
                	?>
				</tbody>
